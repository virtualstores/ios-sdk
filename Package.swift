...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/virtualstores/ios-foundation.git", .exact("0.0.14")),
        .package(url: "https://github.com/virtualstores/ios-position-kit.git", .exact("0.0.12")),
