            ...
            if let id = feature["id"] as? String {
                ...
                case "Polygon":
                    ...
                    let zoneProperties = ZoneProperties(
                        ...
                        triggerPolygon: properties["triggerPolygon"] as? [[[Double]]],
                        parentId: properties["parentId"] as? String,
                        zoneType: properties["zoneType"] as? String,
                        ...
                        fillAlphaSelected: properties["fillAlphaSelected"] as? Double,
                        ...
                        lineOpacitySelected: properties["lineOpacitySelected"] as? Double,
                        ...
                        textOpacitySelected: properties["textOpacitySelected"] as? Double,
